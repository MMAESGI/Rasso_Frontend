...
function getLocation() {
  navigator.geolocation.getCurrentPosition(getLocationName, handleLocationError, {
...
<template>
  <div class="flex items-center">
    <span class="flex items-center mr-5" v-if="city != ''"
      ><i class="pi pi-map-marker"></i> {{ city }}</span
    >
    <ButtonGroup>
      <Button
